...
class TestControlFlow(TestCase):
    ...
    def test_scan_autograd_simple_bf_matmul(self):
        w1 = torch.zeros_like(torch.rand(2, 4, requires_grad=True))
        w2 = torch.zeros_like(torch.rand(2, 4, requires_grad=True))
